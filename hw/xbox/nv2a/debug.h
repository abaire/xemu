...
#define NV2A_PROF_COUNTERS_XMAC \
    _X(NV2A_PROF_UI_SWAPS) \
    _X(NV2A_PROF_UI_LONG_SWAPS) \
...
#define NV2A_PROF_ACCUMULATORS_XMAC \
    ...
    _X(NV2A_PROF_VK_DRAW_BEGIN) \
    _X(NV2A_PROF_VK_DRAW_END) \
    _X(NV2A_PROF_VK_IMAGE_BLIT) \
    _X(NV2A_PROF_VK_PROCESS_PENDING)\
    _X(NV2A_PROF_VK_CLEAR_SURFACE) \
    _X(NV2A_PROF_GL_DRAW_FLUSH) \
    _X(NV2A_PROF_GL_DRAW_END) \
    _X(NV2A_PROF_GL_DRAW_END__FLUSH)\
    _X(NV2A_PROF_GL_DRAW_END__SET_DIRTY) \
    _X(NV2A_PROF_GL_CLEAR_SURFACE) \
    _X(NV2A_PROF_GL_DRAW_BEGIN) \
    _X(NV2A_PROF_GL_DRAW_BEGIN__BIND_TEXTURES) \
    _X(NV2A_PROF_GL_DRAW_BEGIN__BIND_SHADERS)   \
    _X(NV2A_PROF_VK_GET_FRAMEBUFFER_SURFACE)    \
    _X(NV2A_PROF_GL_GET_FRAMEBUFFER_SURFACE)    \
    _X(NV2A_PROF_PFIFO_AWAITING_KICK)           \
    _X(NV2A_PROF_UI_SWAP_TIME_MS)

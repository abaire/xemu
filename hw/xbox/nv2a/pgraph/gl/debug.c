...
static PFNGLGETDEBUGMESSAGELOGPROC _glGetDebugMessageLog = NULL;
...
void gl_debug_initialize(void)
{
    ...
    if (has_GL_KHR_debug) {
        ...
        _glGetDebugMessageLog =
            (PFNGLGETDEBUGMESSAGELOGPROC)SDL_GL_GetProcAddress(
        ...
        _glGetDebugMessageLog = glGetDebugMessageLog;
...
void gl_debug_dump_log()
{
    ...
    GLuint retrieved =
        _glGetDebugMessageLog(num_messages, buffer_size, sources, types, ids,

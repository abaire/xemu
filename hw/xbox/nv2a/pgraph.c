...
{
    NV2A_DPRINTF("NV097_SET_PROJECTION_MATRIX 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_MODEL_VIEW_MATRIX)
{
    ...
    NV2A_DPRINTF("NV097_SET_MODEL_VIEW_MATRIX 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_INVERSE_MODEL_VIEW_MATRIX)
{
    ...
    NV2A_DPRINTF("NV097_SET_INVERSE_MODEL_VIEW_MATRIX 0x%X\n", parameter);
    unsigned int matnum = slot / 16;
    unsigned int entry = slot % 16;
...
DEF_METHOD_INC(NV097, SET_COMPOSITE_MATRIX)
{
    ...
    NV2A_DPRINTF("NV097_SET_COMPOSITE_MATRIX 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_TEXTURE_MATRIX)
{
    ...
    NV2A_DPRINTF("NV097_SET_TEXTURE_MATRIX 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_TEXGEN_PLANE_S)
{
    ...
    NV2A_DPRINTF("NV097_SET_TEXGEN_PLANE_S 0x%X\n", parameter);
    unsigned int tex = slot / 16;
    unsigned int entry = slot % 16;
...
DEF_METHOD_INC(NV097, SET_EYE_POSITION)
{
    ...
    NV2A_DPRINTF("NV097_SET_EYE_POSITION 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_COMBINER_FACTOR0)
{
    ...
    NV2A_DPRINTF("NV097_SET_COMBINER_FACTOR0 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_COMBINER_FACTOR1)
{
    ...
    NV2A_DPRINTF("NV097_SET_COMBINER_FACTOR1 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_COMBINER_ALPHA_OCW)
{
    ...
    NV2A_DPRINTF("NV097_SET_COMBINER_ALPHA_OCW 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_COMBINER_COLOR_ICW)
{
    ...
    NV2A_DPRINTF("NV097_SET_COMBINER_COLOR_ICW 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_VIEWPORT_SCALE)
{
    ...
    NV2A_DPRINTF("NV097_SET_VIEWPORT_SCALE 0x%X\n", parameter);
...
DEF_METHOD_INC(NV097, SET_TRANSFORM_PROGRAM)
{
    ...
    NV2A_DPRINTF("NV097_SET_TRANSFORM_PROGRAM[%d] 0x%X\n", slot, parameter);
...
DEF_METHOD(NV097, SET_BEGIN_END)
{
    ...
    if (parameter == NV097_SET_BEGIN_END_OP_END) {
        ...
        for (uint32_t i = 0; i < 4; ++i) {
            debug_info.texture_config[i].format.v = pg->regs[NV_PGRAPH_TEXFMT0 + i * 4];
            debug_info.texture_config[i].address.v = pg->regs[NV_PGRAPH_TEXADDRESS0 + i * 4];
            debug_info.texture_config[i].control0.v = pg->regs[NV_PGRAPH_TEXCTL0_0 + i * 4];
            debug_info.texture_config[i].control1.v = pg->regs[NV_PGRAPH_TEXCTL1_0 + i * 4];
            debug_info.texture_config[i].filter.v = pg->regs[NV_PGRAPH_TEXFILTER0 + i * 4];
            debug_info.texture_config[i].image_rect.v = pg->regs[NV_PGRAPH_TEXIMAGERECT0 + i * 4];
            debug_info.texture_config[i].border_color = pg->regs[NV_PGRAPH_BORDERCOLOR0 + i * 4];
        }
#endif
